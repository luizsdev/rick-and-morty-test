				...
				<div className="md:w-full xl:w-2/3 flex flex-col sm:flex-row justify-center items-center p-5">
					...
					<div>
						...
						<Link
							href={'/'}
							type="button"
							className="text-gray-800 mt-5 flex items-center justify-center flex-row gap-2 w-32 h-12 bg-gradient-to-r from-teal-200 to-lime-200 hover:bg-gradient-to-l hover:from-teal-200 hover:to-lime-200 focus:ring-4 focus:outline-none focus:ring-teal-700 font-medium rounded-lg text-lg px-5 py-2.5 text-center mr-2 mb-2"
						>
							<BiArrowBack /> Home
						</Link>
					</div>
